      ...
      <main className=" bg-white px-[15px] md:px-20 lg:px-40 dark:bg-gray-900">
        <section className=" min-h-screen">
          ...
          <div className="text-center p-4">
            ...
            <p className="text-md py-5 leading-6 text-gray-800 md:text-xl max-w-xl mx-auto dark:text-white">
              As a front-end software engineer, I have a strong foundation in
              HTML, CSS, and JavaScript, ReactJs and NextJs and have experience
              building responsive and interactive websites and web applications.
            </p>
            ...
            <div className="relative bg-gradient-to-b from-teal-500 rounded-2xl w-90 h-90 mt-20">
              <Image
                ...
                width="230"
                height="230"
                alt="Software Engineer | Elio Youssef"
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-6 text-gray-800 dark:text-white">
              ...
              and <span className="text-teal-500">web applications. </span>
              With a focus on creating intuitive and{" "}
              <span className="text-teal-500"> user-friendly experiences </span>
              , I can help you design and develop custom solutions that meet the
              specific needs of your
              <span className="text-teal-500"> business</span> or{" "}
            ...
            <p className="dark:text-white">
              ...
              is optimized for{" "}
              <span className="text-teal-500">performance </span> and{" "}
              <span className="text-teal-500">accessibility</span>.
            </p>
          </div>
          <div className=" md:flex gap-5">
            <div className="text-center shadow-lg p-[15px] rounded-xl my-10 dark:shadow-white">
              <Image
                ...
                width={100}
                height={100}
                alt="Software Engineer | Elio Youssef | Coding"
              />
              ...
              <div className="p-4">
                <p className="dark:text-white">
                  I have extensive experience with modern front-end technologies
                  and frameworks, including React, NextJs, and am comfortable
                  working with both server-rendered and client-side rendering
                  approaches. Proficient in building responsive layouts using
                  CSS Grid and Flexbox, and have a strong understanding of
                  cross-browser compatibility issues and how to troubleshoot and
                  fix them.
                </p>
              </div>
            </div>
            <div className="text-center shadow-lg p-[15px] rounded-xl my-10 dark:bg-gray-850 dark:shadow-white">
              <Image
                ...
                width={100}
                height={100}
                alt="Software Engineer | Elio Youssef | Consulting"
              />
              <h3 className="text-lg font-medium pt-8 pb-2 text-cyan-500">
                Consulting:
              </h3>
              <div className="p-4">
                <p className="dark:text-white">
                  ...
                  appropriate technologies and approaches to use.
                </p>
              </div>
            </div>
          </div>
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-6 text-gray-800 dark:text-white">
              Thank you for visiting my website. If you have{" "}
              <span className="text-teal-500">any questions </span> or would
              like to{" "}
